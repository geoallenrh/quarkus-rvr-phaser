export default class Pickups extends Phaser.Physics.Arcade.Group
{
    ...
    start ()
    {
        this.create(400, 100, 'assets', 'water');
        this.create(100, 380, 'assets', 'water');
        this.create(700, 380, 'assets', 'water');
        this.create(300, 500, 'assets', 'water');
        this.create(500, 500, 'assets', 'water');
    }
